                        ...
                        <div className="flex flex-col gap-5 rounded-md shadow-sm -space-y-px">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    ${isEmailFocused ? 'border-[#633CFF] bg-white shadow-custom' : 'border-gray-300 bg-transparent'}
                                    ${isError ? 'border-red-600' : ''}`}

                                />
                                <span className="absolute inset-y-0 top-6 flex items-center pl-3">
                                    <Image src="https://res.cloudinary.com/dbnxbly1r/image/upload/v1722023474/general/envelope_r1wmwj.svg" alt="Email Icon" width={16} height={16} />
                                </span>
                                {isError && (
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`block w-full px-3 py-2 pl-10 border rounded-md outline-none ${isPasswordFocused ? 'border-[#633CFF] bg-white shadow-custom' :
                                        'border-gray-300 bg-transparent'
                                        } ${isError ? 'border-red-600' : ''}`}
                                />
                                <span className="absolute inset-y-0 left-0 top-6 flex items-center pl-3">
                                    <Image src="https://res.cloudinary.com/dbnxbly1r/image/upload/v1722023474/general/padlock1_ewnrts.svg" alt="Password Icon" width={16} height={16} />
                                </span>
                                {isError && (
                                    <span className="absolute inset-y-0 right-0 top-6 flex items-center pr-3 text-[#FF3939] text-[12px]">
                                        Please check again
